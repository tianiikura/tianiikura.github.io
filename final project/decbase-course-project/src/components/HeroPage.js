import heroPagePhoto  from "./../assets/img/hero-page-photo.jpg";
export default function HeroPage () {
    return (
        <section class="hero-page">
                <div class="hero-page__deco">                        
                ...
                <div class="hero-page-info"> 
                    <div class="hero-page-info__subtitle">
                        MODERN INTERIOR
                    </div>
                    <div class="hero-page-info__title">
                        Create Your Interior Design.
                    </div>
                    <div class="hero-page-info__text">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.
                    </div>
                    <div class="hero-page-info__contact-button">
                        CONTACT
                    </div>
                </div>
                <div class="hero-page-image">
                    <div class="hero-page__photo">
                        <img src={heroPagePhoto} alt="interior" />
                    </div>
                    <div class="hero-page__photo-decor">
                    </div>
                </div>
            </section>
    )
